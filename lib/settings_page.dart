    ...
    return Column(
        ...
        children: [
          ...
          TextButton(
            ...
            child: Text(
                'Notifications', style: GoogleFonts.indieFlower(fontSize: 30)),
          ),
          TextButton(
            onPressed: () {
              showDialog(
          ...
          TextButton(
            ...
            child: Text(
                'Log out', style: GoogleFonts.indieFlower(fontSize: 30)),
          ),
          TextButton(
            style: ButtonStyle(
              foregroundColor: MaterialStateProperty.all<Color>(Colors.red),
            ...
            child: Text(
                'Delete Account', style: GoogleFonts.indieFlower(fontSize: 30)),
          ),
        ]
    );
  }
